                            ...
                            <div class="col-lg-5">
                                ...
                                <?php   
                                    ...
                                    <?php
                                        ...
                                        if(isset($_POST['them'])){
                                            //su dung cac ham co so du lieu

                                            // lay du lieu da nhap tu form
                                            $data['mssv']=isset($_POST['mssv']) ? $_POST['mssv']:'';
                                            $data['hoten']=isset($_POST['hoten']) ? $_POST['hoten']:'';

                                            //upload hinh anh vao thu muc /assetss tren server  
                                            $hinhanh ="./assets/" .$_FILES['avatar']['name'];
                                            move_uploaded_file($_FILES['avatar']['tmp_name'],$hinhanh);
                                            chendulieu($con,$data['mssv'],$data['hoten'],$hinhanh);
                                            $con ->close();
        ...
        <table border="1" cellspacing="0" cellpadding="10">
            <tr>
                ...
                <td>
                    ...
                    value="<?php echo !empty($data['mssv']) ? $data['mssv']:" ";  ?>"/>
                    <?php echo !empty($errors['mssv']) ?$errors['mssv']:" "; ?>
                </td>
            </tr>
            <tr>
                <td>Tên</td>
                <td>
                    ...
                    value="<?php echo !empty($data['hoten']) ? $data['hoten']: " "; ?>"/>
                    <?php echo !empty($errors['hoten']) ?$errors['hoten']:""; ?>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                Hinh anh :<input type="file" name="avatar"/>
                </td>
            </tr>
            <tr>
                <td colspan="2"><input type="submit" name="them" value="them moi"/></td>
            </tr>
        </table>
    </form>
