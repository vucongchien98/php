...
function chendulieu($con,$mssv,$hinhanh,$hoten){
    $sql="insert into content values('".$mssv ."','" .$hinhanh . "','" .$hoten ."')";
...
function Lay1SV($con, $mssv)
{
    $sql ="select * from content where (`mssv` ='" . $mssv . "')";
