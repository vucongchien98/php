                                    ...
                                    <?php
                                        ...
                                        if (isset($_GET['action']) && $_GET['action'] == 'edit'){
                                            if (isset($_POST['user_id']) && !empty($_POST['user_id']) && isset($_POST['password']) && !empty($_POST['password'])) {
                                                $result = mysqli_query($con,"UPDATE `user` SET `password` = MD5('" . $_POST['password'] ."'),`status`=" .$_POST['status'].",`last_updated` =".time()." WHERE `user_client`.`id` = ".$_POST['user_id'] .";");
                                                if (!$result){
                                                ...
                                                if ($error !== false) {
                                                    ...
                                                    <div id="error-notify" class="box-content">
                                                        <h1>Thông Báo</h1>
                                                        <h4><?= $error ?></h4>
                                                        <a href="./list_client.php">Danh sách tài khoản khác</a>
                                                    </div>
                                                <?php } else { ?>
                                                    <div id="error-notify" class="box-content">
                                                ...
                                                <?php } else { ?>
                                                    <div id="edit_notify" class="box-content">
                                                        ...
                                                        <a href="./changepass_cl.php?id=<?=$_POST['user_id'] ?>">Quay lại sửa tài khoản</a>
                                                    </div>
                                                    <?php }
                                        } else {
                                                $result = mysqli_query($con, "SELECT * FROM user_client where `id`=" .$_GET['id']);
                                                    ...
                                                    if (!empty($user)) {
                                                        ...
                                                        <div id="edit_user" class="box-content">
                                                            ...
                                                            <form action="./changepass_cl.php?action=edit" method="Post" autocomplete="off">
