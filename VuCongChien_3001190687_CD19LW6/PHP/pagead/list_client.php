...
<html lang="en">
    ...
    <div id="layoutAuthentication">
        ...
        $result = mysqli_query($con, "SELECT * FROM user_client");
        mysqli_close($con);
        ?>  

            <table class="table table-striped" style="width:700px;">
            <th>Danh sách user client</th>
                <tr>
                    <td>Username</td>
                    <td>Trạng thái</td>
                ...
                <tr>
                    ...
                    <td><a href="./changepass_cl.php?id= <?= $row['id'] ?>">Sửa</a></td>
                    <td><a href="./delete_cl.php?id= <?= $row['id'] ?>">Xóa</a></td></td>
                </tr>
                <?php } ?>
            </table> 
                                </div>
