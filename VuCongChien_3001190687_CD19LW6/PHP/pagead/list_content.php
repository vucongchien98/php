...
<html lang="en">
    ...
    ?>
     <div id="user-info">
            <h2 class="justify-content-center">Danh sách bài viết</h2>
            <a href="./upload.php" class="btn btn-danger" style="margin-bottom: 5px;">tạo bài viết mới</a>
            <table class="table table-bordered border-primary" style="width:700px;">
                ...
                <tr>
                    ...
                    <td width="10%"><a href="delete_ct.php?mssv= <?= $row['mssv'] ?>">Xóa</a></td>
                </tr>
                <?php } ?>
            </table>
        </div>
